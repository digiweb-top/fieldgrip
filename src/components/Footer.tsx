        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 items-center">
          ...
          <div className="flex justify-center md:justify-end">
            <div className="flex space-x-4">
              {/* Facebook */}
              <a 
                href="https://facebook.com/fieldgrip" 
                target="_blank" 
                rel="noopener noreferrer" 
                aria-label="Fieldgrip on Facebook"
              ...
              {/* Instagram */}
              <a 
                href="https://instagram.com/fieldgrip" 
                target="_blank" 
                rel="noopener noreferrer" 
                aria-label="Fieldgrip on Instagram"
                className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-green-600 transition-colors duration-200"
              >
                <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
              ...
              {/* Twitter */}
              <a 
                href="https://twitter.com/fieldgrip" 
                target="_blank" 
                rel="noopener noreferrer" 
                aria-label="Fieldgrip on Twitter"
                className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-green-600 transition-colors duration-200"
              >
                <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
              ...
              {/* YouTube */}
              <a 
                href="https://youtube.com/@fieldgrip" 
                target="_blank" 
                rel="noopener noreferrer" 
                aria-label="Fieldgrip on YouTube"
                className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-green-600 transition-colors duration-200"
              >
                <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
